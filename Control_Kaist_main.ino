...
void hyCANSAT_M7_OPERATION() { DDRA = 0xF7 ; hyCANSAT_MSG_OPERATION(RxMode_M7); }
...
//  hyCANSAT_M4_OPERATION();
//  hyCANSAT_M5_OPERATION();
//  hyCANSAT_M6_OPERATION();
...
//  DDRA  = 0xF7 ; // for DTLM CMD : output // for INPUT M7
	PORTA = 0x00 ;
